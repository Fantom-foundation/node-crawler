...
export function Note() {
  ...
  <Alert status="info" onClick={hideNote} mt={4}>
    <AlertIcon />
     This crawler only has a partial view of the Opera network and lists only nodes discovered in last 24 hours. This is not a full count of every node on the network.
    ...
    <Grid templateColumns="repeat(2, 1fr)" pt={LayoutEightPadding} pl={LayoutEightPadding} pr={LayoutEightPadding} w="100%">
      <Flex direction={['column', 'row', 'row']} justifySelf="flex-start" fontSize={16} fontWeight={400}>
        <HStack>
          ...
          <Text fontWeight="bold" fontSize="larger" whiteSpace="nowrap">Opera Nodes</Text>
        </HStack>
      </Flex>
